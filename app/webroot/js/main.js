...
$(document).ready(function () {
    ...
    $("#collapse-filter-btn").click(function (e) {
        if ($("#collapse-filter").hasClass("in")) { //is showed
            $(this).html('<span class="glyphicon glyphicon-chevron-down"></span> Show advanced search fields');
        } else {
            $(this).html('<span class="glyphicon glyphicon-chevron-up"></span> Hide advanced search fields');
        }
    });
